...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/playlist/edit', [PlaylistController::class, 'edit'])->name('playlist.edit');
    Route::get('/playlist/update', [PlaylistController::class, 'update'])->name('playlist.update');
